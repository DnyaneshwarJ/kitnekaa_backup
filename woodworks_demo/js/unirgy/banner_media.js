var UnirgyBannerGallery=Class.create({initialize:function(images,options){this.options={imageSwitchDuration:.5,containerId:'banner-slider',width:950,height:316,html_tpl:'<a href="#{target_url}"><img src="#{img_url} title="#{title}" width="#{width}" height="#{height}"/></a>',startPosition:1,cycle:'none',cycleDuration:10}
Object.extend(this.options,options)
this.images=images
this.selImgIdx=0
this.switching=false
this.initImages()
try{for(var i=0;i<this.images.length;i++){var imgCfg={}
