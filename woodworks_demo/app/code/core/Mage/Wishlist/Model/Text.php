 ...
 */
class Mage_Wishlist_Model_Text extends Mage_Core_Model_Abstract
{
   ...
   /**
     ...
     * @var string
     */
    protected $_eventPrefix = 'wishlist_text';
    ...
    /**
     * Set Item name Or shoppinglist Item name.
     *
     * @param varchar  $list_item
     * @return Mage_Wishlist_Model_Item
     */
    public function setItemName($item_name)
    {
    	$this->setData('item_name', $item_name);
    	return $this;
    }
    /**
     * Set Target price.
     ...
     * @return Mage_Wishlist_Model_Item
     */
    public function setTaretPrice($target_price)
    {
    	$this->setData('target_price', $target_price);
    	return $this;
    }
    /**
     * Set Target price.
     ...
     * @return Mage_Wishlist_Model_Item
     */
    public function setWhenNeed($when_need)
    {
    	$this->setData('when_need', $when_need);
    	return $this;
    }

    public function setPurchaseFrequency($purchase_frequency)
    {
    	$this->setData('purchase_frequency', $purchase_frequency);
    	return $this;
    }
    /**
