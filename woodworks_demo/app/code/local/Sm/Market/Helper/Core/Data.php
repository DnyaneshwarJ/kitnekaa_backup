...
class Sm_Market_Helper_Core_Data extends Mage_Core_Helper_Data
{
    const XML_PATH_MINIFY_ENABLE_YUICOMPRESSOR  = 'market_cfg/advanced/enable_yuicompressor';
	const XML_PATH_MINIFY_ENABLE                = 'market_cfg/advanced/compress_css_js';
