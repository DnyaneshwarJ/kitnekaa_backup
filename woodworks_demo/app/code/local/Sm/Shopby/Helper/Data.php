...
class Sm_Shopby_Helper_Data extends Mage_Core_Helper_Data{

    const MULTIPLE_FILTERS_DELIMITER = ',';

    public function isEnabled(){
        return Mage::getStoreConfigFlag('sm_shopby/catalog/enabled');
    }
    ...
    public function isAjaxEnabled(){
        ...
        return Mage::getStoreConfigFlag('sm_shopby/catalog/use_ajax');
    }
    ...
    public function isMultipleChoiceFiltersEnabled(){
        ...
        return Mage::getStoreConfigFlag('sm_shopby/catalog/multiple_filters');
    }
    ...
    public function isPriceSliderEnabled(){
        ...
        return Mage::getStoreConfigFlag('sm_shopby/catalog/price_slider');
    }

    public function getPriceSliderDelay(){
        return Mage::getStoreConfig('sm_shopby/catalog/price_slider_delay');
    }

    public function getPriceSliderSubmitType(){
        return (int) Mage::getStoreConfig('sm_shopby/catalog/price_slider_submit_type');
    }

    public function getRoutingSuffix()
    {
        return '/' . Mage::getStoreConfig('sm_shopby/catalog/routing_suffix');
    }
