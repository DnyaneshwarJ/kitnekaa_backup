...
require_once Mage::getModuleDir('controllers', 'Bobcares_Quote2Sales') . DS . 'RequestController.php';
class Kitnekaa_Quote2Sales_RequestController extends Bobcares_Quote2Sales_RequestController{
