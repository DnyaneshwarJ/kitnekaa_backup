 ...
 */
class Kitnekaa_Participant_Block_Adminhtml_Shoppinglist_Item extends Mage_Adminhtml_Block_Widget_Grid
{
    protected function _construct()
    {
        $this->setEmptyText(Mage::helper('kitnekaa_participant')->__('No Shopping List Items Found'));
    }
    ...
    protected function _prepareCollection()
    {
		...
		->addCompanyIdFilter($participant)
		->addStatusFilter();
    ...
    {
        $this->addColumn('wishlist_item_id',
            array('header'=>Mage::helper('kitnekaa_participant')->__('Item ID'), 'align'=>'center', 'index'=>'wishlist_item_id'));
