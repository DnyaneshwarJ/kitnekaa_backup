...
$installer->run("ALTER TABLE `{$this->getTable('quote2sales_requests')}` ADD COLUMN product_id int(11) unsigned;"
        . "ALTER TABLE `{$this->getTable('quote2sales_requests')}` ADD COLUMN seller_comment text;");
