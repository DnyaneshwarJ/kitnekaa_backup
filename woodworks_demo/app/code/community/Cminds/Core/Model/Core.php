...
class Cminds_Core_Model_Core extends Mage_Core_Model_Config_Data {
    ...
    private static $items = array(
        ...
        'cminds_supplierfrontendproductuploader' => array(
            'name'              => 'Supplier Frontend Product Upload Extension for Magento',
        ...
        'cminds_freegift' => array(
            'name'              => 'Free Gift and Coupon Extension',
        ...
        'cminds_newsletter' => array(
            'name'              => 'Advanced Newsletter Registration Extension for Magento',
    ...
    public static $confExtensions = array(
        ...
        'cmindsConf_cminds_productreview_coupon' => array('extension_name' => 'Cminds_Productreviewcoupon', 'related_to' => 'Cminds_Marketplace'),
