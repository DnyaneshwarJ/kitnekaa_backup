...
class Gremlin_Ccavenue_RedirectlogController extends Mage_Adminhtml_Controller_Action {
	/**
	* Load grid page
	*/
	...
	*/
	...
	/**
	* Export redirect grid to CSV format
	*/
	...
	/**
	*  Export redirect grid to Excel XML format
	*/
