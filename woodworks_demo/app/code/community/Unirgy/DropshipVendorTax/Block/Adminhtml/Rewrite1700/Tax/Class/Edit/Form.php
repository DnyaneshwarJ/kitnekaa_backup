...
class Unirgy_DropshipVendorTax_Block_Adminhtml_Rewrite1700_Tax_Class_Edit_Form extends Mage_Adminhtml_Block_Widget_Form
{
    ...
    protected function _prepareForm()
    {
        ...
        $this->setTitle($classType == Mage_Tax_Model_Class::TAX_CLASS_TYPE_CUSTOMER
                ? Mage::helper('udropship')->__('Customer Tax Class Information')
                : (
                $classType == Unirgy_DropshipVendorTax_Model_Source::TAX_CLASS_TYPE_VENDOR
                    ? Mage::helper('udropship')->__('Vendor Tax Class Information')
                    : Mage::helper('udropship')->__('Product Tax Class Information')
                )
        );
