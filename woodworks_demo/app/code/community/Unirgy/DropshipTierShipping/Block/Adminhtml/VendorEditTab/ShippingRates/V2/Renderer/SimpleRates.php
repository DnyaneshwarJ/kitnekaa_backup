...
class Unirgy_DropshipTierShipping_Block_Adminhtml_VendorEditTab_ShippingRates_V2_Renderer_SimpleRates extends Mage_Adminhtml_Block_Widget implements Varien_Data_Form_Element_Renderer_Interface
{
    ...
    public function __construct()
    {
        parent::__construct();
        if (!$this->getTemplate()) {
            $this->setTemplate('udtiership/vendor/form/renderer/v2/simple_rates.phtml');
        }
    }
