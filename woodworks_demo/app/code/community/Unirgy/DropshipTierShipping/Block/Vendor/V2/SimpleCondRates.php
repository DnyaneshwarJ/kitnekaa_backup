...
class Unirgy_DropshipTierShipping_Block_Vendor_V2_SimpleCondRates extends Mage_Core_Block_Template implements Varien_Data_Form_Element_Renderer_Interface
{
    ...
    public function __construct()
    {
        parent::__construct();
        if (!$this->getTemplate()) {
            $this->setTemplate('unirgy/tiership/vendor/v2/simple_cond_rates.phtml');
        }
    }
    ...
    {
        return Mage::app()->getLayout()->getBlockSingleton('udtiership/vendor_v2_simpleCondRates_subrows')
            ->setTemplate('unirgy/tiership/vendor/v2/simple_cond_rates/subrows.phtml')
