 ...
 */
class Unirgy_DropshipMultiPrice_Model_PriceIndexer_CE1600_Grouped
    extends Unirgy_DropshipMultiPrice_Model_PriceIndexer_CE1600_Default
{
    /**
    ...
    protected function _prepareGroupedProductPriceData($entityIds = null)
    {
        ...
        foreach ($canStates as $csKey=>$csLbl) {
            $minCheckSql = $write->getCheckSql('le.required_options = 0', 'i.udmp_'.$csKey.'_min_price', 0);
            $maxCheckSql = $write->getCheckSql('le.required_options = 0', 'i.udmp_'.$csKey.'_max_price', 0);
            $cntCheckSql = $write->getCheckSql('le.required_options = 0', 'i.udmp_'.$csKey.'_cnt', 0);
