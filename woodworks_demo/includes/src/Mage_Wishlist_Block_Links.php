...
class Mage_Wishlist_Block_Links extends Mage_Page_Block_Template_Links_Block
{
    ...
    protected function _getItemCount()
    {
        ...
        return ($this->helper('wishlist')->getItemCount()+$wishlist->getTextsCount());
     }
    ...
    {
        if ($count > 1) {
            return $this->__('My Shopping List (%d items)', $count);
        } else if ($count == 1) {
            return $this->__('My Shopping List (%d item)', $count);
        } else {
            return $this->__('My Shopping List');
        }
    }
