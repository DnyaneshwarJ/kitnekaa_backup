 ...
 */
class Mage_Wishlist_Model_Resource_Text extends Mage_Core_Model_Resource_Db_Abstract
{
    /**
    ...
    {
        $this->_init('wishlist/text', 'wishlist_text_id');
    }
     ...
     */
    public function loadWishlistTextItems($object, $wishlistId, $sharedStores)
    {
