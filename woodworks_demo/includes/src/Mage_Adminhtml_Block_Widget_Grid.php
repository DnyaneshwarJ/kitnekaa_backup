...
class Mage_Adminhtml_Block_Widget_Grid extends Mage_Adminhtml_Block_Widget {
	...
	protected function _prepareLayout() {
		$this->setChild ( 'export_button', $this->getLayout ()->createBlock ( 'adminhtml/widget_button' )->setData ( array (
				'label' => Mage::helper ( 'adminhtml' )->__ ( 'Export' ),
				'onclick' => $this->getJsObjectName () . '.doExport()',
				'class' => 'task' 
		) ) );
		$this->setChild ( 'reset_filter_button', $this->getLayout ()->createBlock ( 'adminhtml/widget_button' )->setData ( array (
				'label' => Mage::helper ( 'adminhtml' )->__ ( 'Reset Filter' ),
				'onclick' => $this->getJsObjectName () . '.resetFilter()' 
		) ) );
		$this->setChild ( 'search_button', $this->getLayout ()->createBlock ( 'adminhtml/widget_button' )->setData ( array (
				'label' => Mage::helper ( 'adminhtml' )->__ ( 'Search' ),
				'onclick' => $this->getJsObjectName () . '.doFilter()',
				'class' => 'task' 
		) ) );
		$this->setChild ( 'upload_shoppinglist_button', $this->getLayout ()->createBlock ( 'adminhtml/widget_button' )->setData ( array (
				'label' => Mage::helper ( 'adminhtml' )->__ ( 'Upload Shoppinglist' ),
				'onclick' => $this->getJsObjectName () . '.doUplaodShoppingList()',
				'class' => 'shoppinglist' 
		) ) );
	...
	public function getUploadShoppingButtonsHtml() {
		return $this->getChildHtml ( 'upload_shoppinglist_button' );
	}
	public function getMainButtonsHtml() {
		$html = '';
		if ($this->getFilterVisibility ()) {
			if($this->getId()=='wishlistGrid')
			{
				$html .= $this->getUploadShoppingButtonsHtml ();
			}
	...
	public function addColumn($columnId, $column) {
		if (is_array ( $column )) {
			$this->_columns [$columnId] = $this->getLayout ()->createBlock ( 'adminhtml/widget_grid_column' )->setData ( $column )->setGrid ( $this );
		}  /*
	...
	protected function _prepareMassactionColumn() {
		$columnId = 'massaction';
		$massactionColumn = $this->getLayout ()->createBlock ( 'adminhtml/widget_grid_column' )->setData ( array (
	...
	public function addExportType($url, $label) {
		$this->_exportTypes [] = new Varien_Object ( array (
	...
	public function addRssList($url, $label) {
		$this->_rssLists [] = new Varien_Object ( array (
	...
	public function getCsvFile() {
		...
		$this->_exportIterateCollection ( '_exportCsvItem', array (
				$io 
		) );
	...
	public function getExcelFile($sheetName = '') {
		...
		$this->_exportIterateCollection ( '_exportExcelItem', array (
				$io,
				$parser 
		) );
