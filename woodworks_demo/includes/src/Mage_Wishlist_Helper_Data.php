...
class Mage_Wishlist_Helper_Data extends Mage_Core_Helper_Abstract
{
     ...
     * @return string
     */
    public function getRemoveUrl($item,$is_product)
    {
    	if($is_porduct){
    		return $this->_getUrl('wishlist/index/remove',
    				array('item' => $item->getWishlistItemId(),'is_product'=>$is_product)
    		);
    	}else{
    		return $this->_getUrl('wishlist/index/remove',
    				array('item' => $item->getWishlistTextId(),'is_product'=>$is_product)
    		);
    	}
    ...
    {
    	return $this->_getUrl('wishlist/ajax/suggest', array(
    ...
    {
    	return $this->_queryText = $this->_getRequest()->getParam('item_name');
    }
