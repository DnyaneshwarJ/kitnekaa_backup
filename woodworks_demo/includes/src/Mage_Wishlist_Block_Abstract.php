...
abstract class Mage_Wishlist_Block_Abstract extends Mage_Catalog_Block_Product_Abstract
{
     ...
     * @return Mage_Wishlist_Model_Resource_Item_Collection
     */
    protected function _createWishlistTextCollection()
    {
    	return $this->_getWishlist()->getTextCollection();
    }
    ...
    public function getWishlistTexts()
    {
    	
    	 	return $this->_createWishlistTextCollection();
    }
     ...
     * @return string
     */
    public function getItemRemoveUrl($item,$is_product=false)
    {
    	
        return $this->_getHelper()->getRemoveUrl($item,$is_product);
    }
    ...
    public function getWishlistTextsCount()
    {
    	return $this->_getWishlist()->getTextsCount();
    }
    ...
    public function hasWishlistItems()
    {
     ...
     public function hasWishlistTexts()
    {
        return $this->getWishlistTextsCount() > 0;
    }
    ...
    /**
     * Retrieve URL for adding Product to shoppinglist
     *
     * @param Mage_Catalog_Model_Product $product
     * @return string
     */
    public function getAddShoppinglistItemUrl()
    {
    	return "Hello" ;die();$this->_getHelper()->getAddItemUrl();
    }
     ...
     * @return string
     */
    public function getItemEditUrl($item,$isProduct=false)
    {
    	$id = $item->getId();
    	$params = array('id' => $id,'isProduct'=>$isProduct);
    
    	return $this->getUrl('wishlist/index/editItem/', $params);
    }
}
