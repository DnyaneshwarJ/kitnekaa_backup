 ...
 */
class Unirgy_DropshipVendorTax_Model_Rewrite1900_Tax_Calculation_Rule extends Mage_Core_Model_Abstract
{
    /**
    ...
    public function saveCalculationData()
    {
        ...
        $vtc = $this->getData('tax_vendor_class');
    ...
    public function fetchUdRuleCodes($rateId, $customerTaxClassId, $productTaxClassId, $vendorTaxClassId)
    {
        return $this->getResource()->fetchUdRuleCodes($rateId, $customerTaxClassId, $productTaxClassId, $vendorTaxClassId);
    }
}
