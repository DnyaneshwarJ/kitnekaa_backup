 ...
 */
class Unirgy_DropshipVendorTax_Model_Rewrite1700_Tax_Sales_Total_Quote_Tax extends Mage_Sales_Model_Quote_Address_Total_Abstract
{
    /**
     * Tax module helper
     *
    ...
    protected function _calculateShippingTax(Mage_Sales_Model_Quote_Address $address, $taxRateRequest)
    {
        ...
        $shipTaxTotal['baseTax'] = $baseTax;
        $shipTaxTotal['tax'] = $tax;
        $shipTaxTotal['hiddenTax'] = $hiddenTax;
        $shipTaxTotal['baseHiddenTax'] = $baseHiddenTax;
        ...
        foreach ($items as $item) {
            ...
            if ($item->getHasChildren() && $item->isChildrenCalculated()) {
                foreach ($item->getChildren() as $child) {
                    ...
                    Mage::helper('udtax')->setVendorClassId($taxRateRequest, $child);
                    $rate = $this->_calculator->getRate($taxRateRequest);
