...
class Unirgy_DropshipMulti_Block_Vendor_ProductAttribute_Renderer_TierPrice extends Mage_Adminhtml_Block_Widget implements Varien_Data_Form_Element_Renderer_Interface
{
    ...
    public function __construct()
    {
        parent::__construct();
        if (!$this->getTemplate()) {
            $this->setTemplate('unirgy/udmulti/vendor/product/tier_price.phtml');
        }
    }
