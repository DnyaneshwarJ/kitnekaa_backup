...
class Unirgy_DropshipMulti_Model_Stock extends Mage_CatalogInventory_Model_Mysql4_Stock
{
    public function getProductsStock($stock, $productIds, $lockRows = false)
    {
        $rows = parent::getProductsStock($stock, $productIds, $lockRows);
        $vCollection = Mage::helper('udmulti')->getActiveMultiVendorData($productIds);
