 ...
 */
class Unirgy_Dropship_Model_StockIndexer_EE11300_Default
    extends Mage_CatalogInventory_Model_Resource_Indexer_Stock_Default
{
    ...
    protected function _getStockStatusSelect($entityIds = null, $usePrimaryTable = false)
    {
        ...
        $uvExpr = $this->_addAttributeToSelect($select, 'udropship_vendor', 'e.entity_id', 'cs.store_id');

        $localVendorId = Mage::helper('udropship')->getLocalVendorId();
        $inStockExpr = $adapter->getCheckSql("$uvExpr!=$localVendorId", 1, 'cisi.is_in_stock');
