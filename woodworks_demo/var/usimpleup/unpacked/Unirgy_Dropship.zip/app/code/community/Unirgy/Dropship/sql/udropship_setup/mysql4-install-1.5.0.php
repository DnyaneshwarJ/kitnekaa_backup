...
$this->_conn->addColumn($this->getTable('sales_flat_quote_address'), 'udropship_shipping_details', 'text');
...
$this->_conn->addColumn($this->getTable('sales_flat_quote_address_item'), 'udropship_vendor', 'int unsigned');
