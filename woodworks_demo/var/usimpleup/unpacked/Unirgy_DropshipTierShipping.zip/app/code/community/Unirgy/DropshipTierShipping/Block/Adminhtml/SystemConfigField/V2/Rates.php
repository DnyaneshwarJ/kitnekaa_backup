...
class Unirgy_DropshipTierShipping_Block_Adminhtml_SystemConfigField_V2_Rates extends Mage_Adminhtml_Block_System_Config_Form_Field
{
    ...
    public function __construct()
    {
        parent::__construct();
        if (!$this->getTemplate()) {
            $this->setTemplate('udtiership/system/form_field/v2/rates.phtml');
        }
    ...
    {
        return Mage::app()->getLayout()->getBlockSingleton('udtiership/adminhtml_systemConfigField_v2_rates_subrows')
            ->setTemplate('udtiership/system/form_field/v2/rates/subrows.phtml')
