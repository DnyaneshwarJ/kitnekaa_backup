...
class Unirgy_DropshipTierShipping_Block_Adminhtml_SystemConfigField_V2_SimpleRates extends Mage_Adminhtml_Block_System_Config_Form_Field
{
    ...
    public function __construct()
    {
        parent::__construct();
        if (!$this->getTemplate()) {
            $this->setTemplate('udtiership/system/form_field/v2/simple_rates.phtml');
        }
