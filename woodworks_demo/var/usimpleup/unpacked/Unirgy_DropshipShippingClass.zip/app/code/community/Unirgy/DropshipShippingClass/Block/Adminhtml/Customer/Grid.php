...
class Unirgy_DropshipShippingClass_Block_Adminhtml_Customer_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    {
        $collection = Mage::getModel('udshipclass/customer')
            ->getCollection()
