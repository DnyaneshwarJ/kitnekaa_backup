 ...
 */
class Unirgy_DropshipMultiPrice_Model_PriceIndexer_CE1600_Bundle extends Unirgy_DropshipMultiPrice_Model_PriceIndexer_CE1600_Default
{
    /**
    ...
    protected function _calculateBundleOptionPrice()
    {
        ...
        foreach ($canStates as $csKey=>$csLbl) {
            $select->columns(array(
                'udmp_'.$csKey.'_min_price' => new Zend_Db_Expr('NULL'),
                'udmp_'.$csKey.'_max_price' => new Zend_Db_Expr('NULL'),
                'udmp_'.$csKey.'_cnt'       => new Zend_Db_Expr('NULL'),
            ));
        }
